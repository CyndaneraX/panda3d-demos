...
class ToonsVsCogsTheUltimate(DirectObject):
    def __init__(self):
        ...
        # Moving Around Mouse
        Spin1 = LerpHprInterval(self.Mouse, duration=0.6, hpr=(176.42, 0, 0), blendType='easeInOut')
        Run1 = LerpPosInterval(self.Mouse, duration=0.6, pos=(1.30, -3.00, 0.00), blendType='easeInOut')
        Spin2 = LerpHprInterval(self.Mouse, duration=0.6, hpr=(95.71, 0, 0), blendType='easeInOut')
        Run2 = LerpPosInterval(self.Mouse, duration=0.6, pos=(-3.00, -3.00, 0.00), blendType='easeInOut')
        Spin3 = LerpHprInterval(self.Mouse, duration=0.6, hpr=(181.97, 0, 0), blendType='easeInOut')
        Run3 = LerpPosInterval(self.Mouse, duration=0.6, pos=(-3.00, -17.00, 0.00), blendType='easeInOut')
        Run4 = LerpPosInterval(self.Mouse, duration=0.6, pos=(-5.00, -14.00, 0.00), blendType='easeInOut')
        Spin4 = LerpHprInterval(self.Mouse, duration=0.6, hpr=(0.00, 0.00, 0.00), blendType='easeInOut')
        Run5 = LerpPosInterval(self.Mouse, duration=0.6, pos=(-5.00, -12.00, 0.00), blendType='easeInOut')
        Run6 = LerpPosInterval(self.Mouse, duration=0.6, pos=(-5.00, -10.00, 0.00), blendType='easeInOut')
        self.Walking = Sequence(Func(self.Mouse.loop, 'run'), Spin1, Run1, Spin2, Run2, Spin3, Run3, Run4, Spin4, Run5, Run6)
        self.ChatBox.hide()
        self.ChatBox2.hide()
        self.ChatBox3.hide()
        self.ChatBox4.hide()
        ...
        movementSequence = Sequence(Wait(2.0), Wait(1.8),
                            ...
                            Wait(0), LerpHprInterval(camera, 0, (270, 0, 0)), 
                            Wait(9), LerpPosInterval(camera, 0, (13, 4, 4)),
                            Wait(0), LerpHprInterval(camera, 0, (90, 0, 0)),
                            Wait(0), LerpPosInterval(camera, 0, (-14, -10, 4)),
                            Wait(0), LerpHprInterval(camera, 0, (270, 0, 0))
                            )
        ...
        mainIval = Sequence(
            ...
            Wait(0.5),
            Func(self.KomosoEyes.setTexture, self.AngerEyes, 1),
            Func(self.ChatBox3.show),
            Func(self.doTalk, self.text3, "PLEASE LEAVE!", self.Cat_Exclaim),
            Wait(1.0),
            Func(self.ChatBox3.hide),
            Wait(2),
            Func(self.ChatBox.show),
            Func(self.doTalk, self.text, "Anyways we will continu-", self.Cat_Long),
            Wait(1.0),
            Func(self.ChatBox.hide)
            )
        mainIval.start()
